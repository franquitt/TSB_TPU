 ...
 */
public class HashtableDA<K,V> implements Map<K,V>, Cloneable, Serializable
{
     ...
     */
    public HashtableDA(int initial_capacity)
    {
     ...
     */
    public HashtableDA(int initial_capacity, float load_factor)
    {
     ...
     */
    public HashtableDA(Map<? extends K,? extends V> t)
    {
        this(11, 0.5f);
        this.putAll(t);
    }
    ...
    {
        // HACER...
        HashtableDA<K, V> t = (HashtableDA<K, V>)super.clone();
    ...
    private int search_for_index(K key, int ik)
    {
        for(int j=0; ;j++)
        {
            ...
            if(key.equals(entry.getKey()) && entry.getState() == CLOSED)
            {
                return ik;
            }
        }
    ...
    private class KeySet extends AbstractSet<K> 
    {
        ...
        public int size() 
        {
            return HashtableDA.this.count;
        }
        
        @Override
        public boolean contains(Object o) 
        {
            return HashtableDA.this.containsKey(o);
        }
        
        @Override
        public boolean remove(Object o) 
        {
            return (HashtableDA.this.remove(o) != null);
        }
        
        @Override
        public void clear() 
        {
            HashtableDA.this.clear();
        }
        ...
        private class KeySetIterator implements Iterator<K>
        {
            ...
            public KeySetIterator()
            {
                ...
                actual = -1;
                previo = -1;
                t = (Map.Entry<K, V>[]) HashtableDA.this.table;
                next_ok = false;
                expected_modCount = HashtableDA.this.modCount;
            }
            ...
            public boolean hasNext() 
            {
                ...
                do {
                    i++;
                } while (i < t.length && ((Entry)table[i]).getState() != CLOSED);
                return (i < t.length);
            }
            ...
            public K next() 
            {
                ...
                if(HashtableDA.this.modCount != expected_modCount)
                {    
                ...
                do {
                    actual++;
                }while (actual<t.length && ((Entry)table[actual]).getState() != CLOSED);
            ...
            public void remove() 
            {
                ...
                ((Entry)table[actual]).setState(TOMBSTONE);
                ...
                HashtableDA.this.count--;

                // fail_fast iterator...
                HashtableDA.this.modCount++;
                expected_modCount++;
            }     
        }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> 
    {
        ...
        private class EntrySetIterator implements Iterator<Map.Entry<K, V>>
        {
            ...
            public Map.Entry<K, V> next() 
            {
                ...
                return (Map.Entry<K, V>) table[actual];
            }
            ...
            public void remove() 
            {
                ...
                ((Entry) t[actual]).setState(TOMBSTONE);
                actual = previo;
                // avisar que el remove() válido para next() ya se activó...
                next_ok = false;
    ...
    private class ValueCollection extends AbstractCollection<V> 
    {
        ...
        public boolean contains(Object o) 
        {
            return HashtableDA.this.containsValue(o);
        }
        ...
        private class ValueCollectionIterator implements Iterator<V>
        {
            ...
            public ValueCollectionIterator()
            {
                ...
                this.previo = -1;
                this.actual = -1;
                this.t = (Map.Entry<K, V>[]) HashtableDA.this.table;
                this.next_ok = false;
                this.expected_modCount = HashtableDA.this.modCount;
            }
